#!/bin/bash
curl -X POST -H "Content-Type: application/json" http://user:pass@172.26.133.141:5984/_cluster_setup -d '{"action": "enable_cluster", "bind_address":"0.0.0.0", "username": "user", "password":"pass", "node_count":"3"}'
curl -X POST -H "Content-Type: application/json" http://user:pass@172.26.133.82:5984/_cluster_setup -d '{"action": "enable_cluster", "bind_address":"0.0.0.0", "username": "user", "password":"pass", "node_count":"3"}'
curl -X POST -H "Content-Type: application/json" http://user:pass@172.26.134.37:5984/_cluster_setup -d '{"action": "enable_cluster", "bind_address":"0.0.0.0", "username": "user", "password":"pass", "node_count":"3"}'
